...
| `<leader>pt` | Terminals               | Selector de terminales       |
...
| `<leader>gt` | Git status (NvChad)  | Estado con Telescope |
| `<leader>gc` | Commits              | Historia de commits  |
| `<leader>gC` | Commits del buffer   | Del archivo actual   |
| `<leader>cm` | Git commits (NvChad) | Historia de commits  |
...
| `<leader>fm` | Formatear (NvChad)     | Formatear archivo       |
...
| `<leader>ds` | LSP diagnostic loclist | Lista de diagnósticos   |
...
| Tecla        | Acción                    | Descripción        |
| ------------ | ------------------------- | ------------------ |
| `<leader>b`  | Nuevo buffer              | Crear buffer vacío |
...
| `<leader>x`  | Cerrar buffer (NvChad)    | Cerrar actual      |
| `<Tab>`      | Siguiente buffer (NvChad) | Navegar adelante   |
| `<S-Tab>`    | Buffer anterior (NvChad)  | Navegar atrás      |
...
| `<leader>wS` | Toggle separadores    | Cambiar estilo de bordes |
| `<leader>wK` | WhichKey todos        | Ver todos los keymaps    |
| `<leader>wk` | WhichKey query        | Buscar keymap específico |
...
| Tecla       | Modo            | Acción                     |
| ----------- | --------------- | -------------------------- |
| `<leader>h` | Normal          | Nuevo terminal horizontal  |
| `<leader>v` | Normal          | Nuevo terminal vertical    |
| `<A-h>`     | Normal/Terminal | Toggle terminal horizontal |
| `<A-v>`     | Normal/Terminal | Toggle terminal vertical   |
| `<A-i>`     | Normal/Terminal | Toggle terminal flotante   |
| `<C-x>`     | Terminal        | Salir de modo terminal     |
...
| `<leader>/`  | Normal/Visual | Toggle comment (línea/selección) |
| `<leader>ch` | Normal        | NvChad cheatsheet                |
| `<leader>n`  | Normal        | Toggle line number               |
| `<leader>rn` | Normal        | Toggle relative number           |
| `<leader>e`  | Normal        | NvimTree focus                   |
| `<C-n>`      | Normal        | NvimTree toggle                  |
| `<C-s>`      | Normal        | Guardar archivo                  |
| `<C-c>`      | Normal        | Copiar todo el archivo           |
| `<Esc>`      | Normal        | Limpiar resaltados               |
